...
@FacesValidator("de.avci.joride.utils.validators.JorideLongitudeValidator")

public class JorideLongitudeValidator extends JorideValidator{
	...
	@Override
	public void validate(FacesContext context, UIComponent component, Object longitudeO)
