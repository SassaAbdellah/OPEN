...
public class JWaypointEntity extends WaypointEntity implements Serializable,
	...
	public void smartUpdate() {
		...
		try {
			...
			String positionS = hru
					.getParameterSingleValue(getParamNamePosition());
			...
			if (rideIdS != null) {
				try {
					...
					DriverUndertakesRideEntity drive = new JDriverUndertakesRideEntityService()
							.getDriveByIdSafely(rideId);
	...
	public boolean getLocationSet() {
		...
		return (this.getLatitude() != null && this.getLongitude() != null && this
				.getDescription() != null);
	...
	public boolean getRideAttached() {
		...
		return (this.getRideId() != null) && (this.getRouteIdx() != null);
	}
	...
	/**
	 * Position of waypoint to be displayed. Since rideIdx property is 0-based,
	 * we use this to display a 1-based route index.
	 * 
	...
	/**
	 * Wayponts are naturally compared by comparing the route index. Lower Ride
	 * Index comes firs.
	 * 
	 * @param o
	 * @return
	...
	public int compareTo(JWaypointEntity o) {
		...
		if (this.getRouteIdx() > o.getRouteIdx()) {
			return 1;
		}
		if (this.getRouteIdx() < o.getRouteIdx()) {
			return -1;
