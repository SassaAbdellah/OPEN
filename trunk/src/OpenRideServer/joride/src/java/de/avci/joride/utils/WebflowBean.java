 ...
 * 
 *
 *   To initialize this, set any of the HTTPParameters
 *   back/next/finish/cancel 
 *   to the desired outcome 
 *   (i.e: the navigation key for the desired next/back/cancel/finish page)
 * 
 * 
 *   You can then use the getNext()/getBack()/getCancel()/getFinish() 
 *   methods to navigate dynamically through any webflow.
 *
 *   use clear() to blank out all parameters
 *  
 *
 *   Note that this has session view to survive several pages.
 *   The backdraw is, that there can only be one webflow at a time.
 *
 * 
 * 
 * @author jochen
...
public class WebflowBean  implements Serializable {
    ...
    /** Do a smart update, i.e: 
     *  Check out httprequest, and overwrite any of the 
     *  back/next/cancel/finish values
     *  with a corresponding http request parameter,
     *  *provided* the request parameter is !=null.
     * 
     */
