...
public class OpenRideImageCreator {
	...
	/** Key Properties are distinguished by a property 
	 *  name ending with ".key"
	 * 
	 */
	public static String SUFFIX_KEY="key";
	
	
	/** Property name having the suffix ".size" distinguish the 
	 *  encoded witdh and height properties.
	...
	/** Property name having the suffix ".type" distinguish the "type"
	 *  property of an image (aka: OpenRideImageClass)
	 */
	 ...
	 */
	protected static String langPropertiesDir=propertiesDir+"/lang/";
	
	
	
	/** The file containing the "Main Properties"
	 *  for all the OpenRideImages.
	 */
	protected static String mainPropertiesFile=propertiesDir+"images.openrideserver-rs.properties";
	...
	/** Properties Object containing all the meta information,
	 *  on images except the text (which is language dependent)
	 *  
	 */
	 ...
	 * 
	 */
	protected static void loadMainProperties() throws MalformedURLException, IOException{
		
		File propsFile=new File(mainPropertiesFile);
	 ...
	 * @throws MalformedURLException 
	 */
	protected static Properties getLabelMap(String lang) throws MalformedURLException, IOException{
		
		
		
		
		String propsfileName="resources/properties/lang/"+(lang.toUpperCase())+"/images.openrideserver-rs.label.properties";
	...
	protected static String getLocalizedLabel(String key, String lang) throws MalformedURLException, IOException{
	...
	protected static Set <String> getKeys() throws MalformedURLException, IOException{
	 ...
	 * @throws MalformedURLException 
	 */
	protected static OpenRideImageData imageDataFromKey(String key, String lang) throws MalformedURLException, IOException{
		
		System.err.println("=== Loading Image Data from Key "+key+" ===");
		
		
		String basename=key;
		OpenRideImageClass oriClass=new OpenRideImageClass(mainProperties.getProperty(key+"."+SUFFIX_CLASS));
	 ...
	 * 
	 */
	public static void printOutAllImages(String lang) throws MalformedURLException, IOException, FontFormatException{
		
		
		// create an image directory
		
		
        String imageOutputDir=distDirName+"/"+(lang.toUpperCase());
	...
	public static void main(String args[]) throws MalformedURLException, IOException, FontFormatException {
		...
		String[] locales=new File(langPropertiesDir).list();
