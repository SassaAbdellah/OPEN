...
public class JFavoritePointsService {
   ...
   FavoritePointControllerLocal  favouritePointControllerLocal = lookupFavoritePointControllerLocal();
      ...
      /** Add a new favorite Point. The new favorite point is attributed 
       *  to the current user determined from the HTTPAuthPrincipal.
       * 
       * @param jfpe 
       */
      ...
      /** Savely delete the favorite point given as argument.
       *  "Savely delete" means, that the owner of the Favpoint is 
       *  checked against the caller determined from HTTPAuthPrincipal.
       *  If owner and AuthPrincipal do not match, an Error is thrown.
       * 
       * 
       * @param favpointId
       */
       ...
       * 
       *  "Savelymeans, that the owner of the Favpoint is 
       *  checked against the caller determined from HTTPAuthPrincipal.
       *  If owner and AuthPrincipal do not match, an Error is thrown.
       * 
       * @param  favPointId
