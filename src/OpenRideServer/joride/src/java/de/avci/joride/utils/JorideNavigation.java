...
public class JorideNavigation implements Serializable {
    ...
    /** Index of the "home" tab in the main Navigation TAB
     */
    ...
    public int getJorideTabindexHome(){
     ...
     /** Index of the "rider" tab in the main Navigation TAB
     */
    ...
    public int getJorideTabindexRider(){
     ...
     /** Index of the "driver" tab in the main Navigation TAB
     */
    ...
    public int getJorideTabindexDriver(){
     ...
     /** Index of the "Preferences" tab in the main Navigation TAB
     */
