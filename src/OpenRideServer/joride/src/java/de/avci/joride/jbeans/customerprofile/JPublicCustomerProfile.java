 ...
 *  
 *  This is the subset of personal data from {@link JCustomerEntity}
 *  that may safely be displayed to other customers.
 *  
 *  Consequently, this gets created from JCustomerProfile
 *  and has only Getter methods.
 * 
 * 
 * 
 *
...
public class JPublicCustomerProfile implements Serializable {
    ...
    /** Gender should be known to Riders a priori,
     *  since it may effect accept decline decision
     */
    ...
    /** Since when is this user allowed to drive.
     *  Another important information before
     *  deciding on whether or not to acceppt a ride offer.
     * 
     */
